// @firehaha-plugin {"id":"official.damage-dice-helper","name":"原生傷害骰直覺標籤助手","version":"1.1.0","author":"Firehaha","description":"沿用主程式原生傷害骰、重擊與 adventure.damage，提供傷害標籤、重擊、傷害判斷，以及把已擲出的傷害結果交給原生數值減少系統。"}
...
/* Firehaha Damage Dice Helper 1.1.0 - Attack/Damage Bridge */
(function () {
  "use strict";
   ...
   *
   * 注意：
   * - 這裡不自行修改 memorySave 的數值。
   * - 真正的扣值仍交給主程式既有的 [減少] 標籤處理。
   * - 尚未有該傷害結果時，不執行扣值，避免誤扣。
   */
  function processDamageValueReductions(source) {
